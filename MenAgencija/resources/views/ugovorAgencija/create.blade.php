...
<div class="mx-4">
    ...
    >
        ...
        <form method="POST" action="{{route('storeKlijent',$agencija_id)}}">
            @csrf
            <div class="mb-6">
                <label
                    for="nogometas_fk"
                ...
                <select name="nogometas_fk" id="nogometas_fk" class="border border-gray-200 rounded p-2 w-full">
                    <option disabled selected value="">Izaberite nogometaša</option>>   
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{old('Postotak_od_transfera')}}"
                />
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{old('Postotak_od_godisnje_place')}}"
                />
