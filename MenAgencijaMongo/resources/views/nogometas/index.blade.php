                ...
                @foreach($nogometas as $item)
                    <tr class="border-gray-300">
                        <td
                            class="px-4 py-8 border-t border-b border-gray-300 text-lg"
                        >
                           <a href="{{route('showNogometas',$item->_id)}}">{{ $item->Ime}}</a>
                        </td>
                        <td
                            class="px-4 py-8 border-t border-b border-gray-300 text-lg"
                        >
                        <a href="{{route('showNogometas',$item->_id)}}">{{ $item->Prezime}}</a>
                        </td>
                        ...
                        >
                            <a
                                href="{{route('editNogometas',$item->_id)}}"
                        ...
                        <td
                            class="px-4 py-8 border-t border-b border-gray-300 text-lg"
                        >
                        <form method="POST" action="{{route('deleteNogometas',$item->_id)}}">
                            @csrf
                            @method('DELETE')
